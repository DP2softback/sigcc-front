...
const M1LearningPathReviewDetails = Loader(
	lazy(() => import("@features/Modulo1/pages/LearningPath/ReviewDetails/ReviewDetails"))
);
		...
		children: [
			{
				...
				children: [
					{
						path: LEARNING_PATH_REVIEW_DETAILS,
						element: (
							<AppLayout
								allowedRoles={[
									Roles.HR_ADMIN, 
